...
(function($) {
    ...
    $('.project-block, .menu-item').on('click', function() {
    ...
    $('.project-block, .menu-item.project').on('click', function() {
        $('.content-blocks').removeClass('showx');
        $('.content-blocks.project').addClass('showx');
        $('.menu-item').removeClass('active');
        $('.menu-item.project').addClass('active');
    });
...
function initMap() {      
  ...
  var mapOptions = {
      ...
      center: new google.maps.LatLng(10.84590202, 106.634555), // area location
  ...
  //add locations
  var locations = [
      [$('#apkmap').html(), 10.8579599, 106.6285934, 'https://4.bp.blogspot.com/-N0QVjbCb7Sc/XpGXPeJOrvI/AAAAAAAACcU/U61tMBxYp8sMwXpSW0MZPUb6mMtkV0i1ACLcBGAsYHQ/s1600/pin.png', 'Công ty TNHH Tư vấn Thiết kế Xây dựng An Phú Khang'],
      [$('#itomap').html(), 10.7976705, 106.6584012, 'https://4.bp.blogspot.com/-N0QVjbCb7Sc/XpGXPeJOrvI/AAAAAAAACcU/U61tMBxYp8sMwXpSW0MZPUb6mMtkV0i1ACLcBGAsYHQ/s1600/pin.png', 'Công ty TNHH Kiểm toán I.T.O']
